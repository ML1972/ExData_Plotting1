...
# plot in left top position
plot(hpc_subset$Global_active_power~hpc_subset$DateTime,type = "l",
     ylab = "Global Active Power", xlab = "")

# plot in right top position
plot(hpc_subset$Voltage~hpc_subset$DateTime,type = "l",
     ylab = "Voltage", xlab = "datetime")

# plot in left bottom position
with(hpc_subset,plot(Sub_metering_1~DateTime,type = "l",col="black",
                     ylab = "Energy sub metering", xlab = ""))
with(hpc_subset,lines(Sub_metering_2~DateTime,type = "l",col="red"))
with(hpc_subset,lines(Sub_metering_3~DateTime,type = "l",col="blue"))
legend("topright",col=c("black","red","blue"), lty=1,lwd=1, bty="n",
       legend=c("Sub_metering_1 ","Sub_metering_2 ","Sub_metering_3 "))
     
# plot in right bottom position
plot(hpc_subset$Global_reactive_power~hpc_subset$DateTime,type = "l",
     ylab = "Global_reactive_power", xlab = "datetime")

# SAVE PLOT 04 AS PNG FILE #
############################
plot_fname<-"plot4.png"
