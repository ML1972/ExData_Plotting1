...
# Estimate roughly how many MB are used for data base to be analysed
estimatememory<-nrow(hpc_data)*ncol(hpc_data)*8/2^20
...
# SAVE PLOT 01 AS PNG FILE #
############################
plot_fname<-"plot1.png"
